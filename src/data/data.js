...
export const choices = [
    {
        icon: <MdLocalShipping size={25} color='white'  className='absolute m-auto inset-0 ' />,
        heading: "Expertise",
    ...
    {
        icon: <TfiHeadphoneAlt size={25} color='white'  className='absolute m-auto inset-0 ' />,
    ...
    {
        icon: <BsShieldFillCheck size={25} color='white'  className='absolute m-auto inset-0   '/>,
