...
const UsersOrder = ({userOrders}) => {
  ...
  return (
    <div className="max-w-[84vw] mx-auto mt-[10vh]   text-black">
      {userOrders.map((order, index) => (
        <div
          key={index}
          className="flex flex-col  lg:flex-row border     justify-between sm:w-[90%] md:w-full mx-auto lg:w-full h-fit   lg:h-[20vh]  p-4 rounded-xl shadow-lg mb-4"
        >
           <div className=" block lg:hidden  h-full lg-mt-[40px]  lg:h-[12vh] w-[90%] mx-auto lg:w-[6vw] rounded-xl">
                    <img
                      src={order.image || "N/A"}
                      alt="order_image"
          ...
          <div className="flex justify-center items-center w-full">
            <div className="flex gap-3 font-urbanist w-full">
              <div className="w-full">
                <div className="flex   flex-col lg:flex-row justify-start items-center gap-2 lg:gap-5 ">
                ...
                <div className="flex flex-col lg:flex-row justify-start items-center gap-5">
                  <div className=" lg:block hidden h-[80px] lg-mt-[40px]  lg:h-[12vh] w-[80px] lg:w-[6vw] rounded-xl">
                    <img
                      src={order.image || "N/A"}
                      alt="order_image"
                      className="h-full w-full object-cover rounded-xl"
                  ...
                  <div className=" gap-2 text-center lg:text-left font-urbanist text-[1vw]">
