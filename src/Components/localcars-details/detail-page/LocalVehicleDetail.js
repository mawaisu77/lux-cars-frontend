        ...
        <div className="bg-gray-100">
          <div className="flex flex-col lg:flex-row  justify-between mx-auto w-[90%] lg:w-[84vw] lg:pt-[50px] pb-[20px]">
            <div className="w-[100%]   lg:w-[48%] ">
              ...
              <div className=" lg:hidden block w-full lg:w-[48%]">
              ...
              <div className="w-full lg:hidden lg:w-[48%]">
                <div>
                    ...
                    <div>
                      <div className="mt-6">
                        ...
                        <CurrencyInput
                          ...
                          defaultValue={
                            carDetailData?.data?.car?.currentBid
                              ? carDetailData?.data?.car?.currentBid + 500
                              : 500
                          }
                          decimalsLimit={2}
                          value={bidAmount}
                      ...
                      <button className="flex justify-center mt-[2.167vh] items-center gap-x-[0.5vw] h-[5.4vh] text-lg mb-[2.167vh] rounded-[0.7vw] text-white font-semibold bg-gradient-to-l from-green-700 to-green-600 hover:opacity-90 duration-300 shadow-md transform w-full">
                        <span className="text-md lg:text-[1.1vw]">Buy Now</span>
                      </button>
                    </div>
                  )}
