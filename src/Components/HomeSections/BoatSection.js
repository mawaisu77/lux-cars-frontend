...
const BoatSection = () => {
  ...
  const { carData, carLoading, carError } = useGetAllBidsCar(
    "cars/get-all-cars?vehicle_type=boat"
  );
  if (carLoading) {
    return <Shimmer />;
  }
  ...
  const handleViewAllClick = () => {
    navigate("/search-page?vehicle_type=boat"); 
  };
  return (
    <>
      <div className="relative w-full lg:w-[98.9vw] bg-[#f8f8f8]   ">
        <div className="" id="startBidding">
          <div className="pl-2 w-full sm:w-[85vw] justify-between flex md:w-[88vw] lg:w-[82vw] mx-auto items-center ">
