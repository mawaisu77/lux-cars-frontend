    ...
    <React.Fragment>
      ...
      >
        <Tooltip title="My Account">
          ...
          >
            ...
            >
              {user ? user.username.charAt(0) : <AccountCircleIcon />}
            </Avatar>
          </IconButton>
        </Tooltip>
      </Box>
      ...
      >
        ...
        <MenuItem
          onClick={() => {
            handleClose();
            navigate("/user/account/saved-cars");
          }}
        >
          <ListItemIcon>
        ...
        <MenuItem
          onClick={() => {
            handleClose();
            navigate("/user/get-all-invoices");
          }}
        >
          <ListItemIcon>
        ...
        <MenuItem
          onClick={() => {
            handleClose();
            navigate("/user/account/all-bids");
          }}
        >
          <ListItemIcon>
