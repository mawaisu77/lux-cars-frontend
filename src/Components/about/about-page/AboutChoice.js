    ...
    return (
        <>
            <div className='  py-[9.3vh] w-full '>
                ...
                <div className='flex gap-3   justify-center items-center w-[341px] md:w-full lg:w-[60vw] bg-white mx-auto '>
                    <div className='grid grid-cols-1 md:grid-cols-2  gap-5 h-full  justify-center items-center mx-auto w-full '>
                        {choices.map((item, index) => (
                            <div key={index} className='flex flex-col shadow-md rounded-md  gap-5 justify-center items-center h-[370px] lg:h-[39vh]'>
