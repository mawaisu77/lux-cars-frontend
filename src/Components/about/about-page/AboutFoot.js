    ...
    <div className= 'w-[343px] md:w-[80%]      mx-auto '>
        ...
        <div className='text-left mx-auto w-[343px] lg:w-[25vw]   lg:h-[20vh]'>
           <p className='text-[22px] lg:text-34 font-bold font-urbanist pb-[3vh]'> 
            ...
            <p className='text-[14px] lg:text-[1vw] font-urbanist text-[#7a798a]' >Ready to find your perfect car? Contact us today to learn more about our selection and services. Whether you’re looking for a family vehicle, a luxury ride, or something in between, we’re here to help you every step of the way.</p>
          </div>
          <div className='text-left mx-auto w-[343px] lg:w-[25vw]   lg:h-[20vh]'>
             <p className='text-[22px] lg:text-34 font-bold font-urbanist'>
                Follow
             </p>
            ...
            <ImLinkedin className="bg-[#ebebeb] w-[40px] lg:w-[1.5vw] h-[40px] lg:h-[3.4vh] p-[0.2vw] rounded-lg" />
             ...
             <p className='text-[14px] lg:text-[1vw] font-urbanist font-semibold text-[#798196]'>
          ...
          <div className='text-left mx-auto w-[343px]'>
            <div className='text-[22px]  lg:text-[2vw] font-bold font-urbanist'>
            Get in touch
            </div>
            <div  className='flex  items-center gap-[1vw] py-[2.5vh]'>
            <FiMapPin color='red' />
            <p className='text-[22px] lg:text-[1.3vw] font-semibold font-urbanist'>Headuaters</p>
            <p className='text-[14px] lg:text-[1vw] font-urbanist'>Abaco</p>
            <p className='text-[14px] lg:text-[1vw] font-urbanist'>Bahmas</p>
           ...
           <div>
                     ...
                     <p className='text-[14px] text-left lg:text-[1vw] font-semibold font-urbanist'>Calling Support</p>
                     </div>
                     <p  className='text-[14px] lg:text-[1vw] font-urbanist text-[#798196]'>
                     (704) 555-0127
            ...
            <div>
                     ...
                     <p className='text-[14px] lg:text-[1.3vw] font-semibold font-urbanist'>Email Information</p>
                     </div>
                     <p className='text-[14px] lg:text-[1vw] font-urbanist text-[#798196]'>
                     Hello@example.com
