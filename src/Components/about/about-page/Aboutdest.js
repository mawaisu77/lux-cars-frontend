...
const Aboutdest = () => {
    ...
    return (
        <>
            <div className=''>
                <div className='text-[36px] text-lux-black lg:text-[2.3vw] font-urbanist font-semibold pt-[8vh]'>
                    Our Destination
                ...
                <div className='flex gap-3 flex-col lg:flex-row lg:justify-between items-center w-full lg:w-[74vw] h-[330px] lg:h-[11vh] mx-auto mt-10'>
                    <p className='w-[330px] lg:w-[55vw] text-left text-[18px] lg:text-[1vw] text-primary-gray'>
