...
const HowWorks = () => {
  return (
    <>
     ...
     <p className="   text-[36px] lg:text-[2vw]  font-bold font-urbanist">Step-by-Step Guide for Users </p> 
     <p className="text-[16px] lg:text-[0.9vw] text-[#7a798a]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum obcaecati dignissimos
...
<div className=" w-[370px] flex md:w-[40vw] lg:w-[74vw]  mx-auto mt-[5vh] ">
     ...
     <div className=" flex lg:justify-between items-center gap-[2.5vw]   w-[186px]  lg:w-[34vw]  h-[380px] lg:h-[20.3vh] ">
