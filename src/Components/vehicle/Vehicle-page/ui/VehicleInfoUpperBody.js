...
const VehicleInfoUpperBody = ({ carDetailData, liveData, currentBidValue, days, hours, minutes, seconds, ValidDate }) => {
    return (
        ...
        <div className="flex flex-col bg-white justify-evenly w-full  px-[0.5vw] py-[1.08] leading-[4.33vh] rounded-lg ">
          <div className="flex items-center ">
            <p className="font-urbanist text-[#7a798a] lg:text-[0.85vw] ml-2">Lot:</p>
            <p className="font-urbanist font-bold lg:text-[0.97vw] ml-2">{carDetailData?.data?.lot_id || "N/A"}</p>
            <RxCopy
              title="Copy Lot ID"
          ...
          <div className="flex items-center">
            <p className="font-urbanist text-[#7a798a] lg:text-[0.85vw] ml-2">VIN :</p>
            <p className="font-urbanist font-bold lg:text-[0.97vw] ml-2">{carDetailData?.data?.vin || "N/A"}</p>
            <RxCopy
              title="Copy VIN"
              className="cursor-pointer py-[0.1vh] text-[14px] text-gray-600 hover:text-gray-800"
              onClick={() => {
        ...
        <div className="flex flex-col  leading-[4.33vh] rounded-[0.5vw] ">
