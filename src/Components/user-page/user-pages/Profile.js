...
const Profile = () => {
  ...
  <input placeholder='Full Name' className='w-[26vw] h-[4.7vh] rounded-lg p-2 border' />
  <input placeholder='email' className='w-[26vw] h-[4.7vh]  rounded-lg p-2 border' />
  <input placeholder='Number' className='w-[26vw] h-[4.7vh]  rounded-lg p-2 border' />
  <input placeholder='Address' className='w-[26vw] h-[4.7vh]  rounded-lg p-2 border' />
...
<div className='flex justify-center items-center bg-red-600 w-[3vw] h-[6vh] rounded-full'>
  ...
  <div>
    ...
    <p className='text-[1vw] font-urbanist font-semibold'>lorem Ipsum</p>
  </div>
</div>
  ...
  <img src={icon7}/>
        ...
        <div className='flex w-[28vw] h-[12vh]    '>
         ...
         <div className='flex gap-3 ml-5'>
           ...
           Images must be .png or .jpg format. Min size 120x120px (avatar)
           </p>
