...
export default function BenefitsSection() {
  return (
    <div className="mt-5 md:mt-[1.042vw] lg:max-w-[66.667vw] mx-auto p-6 md:p-[1.25vw]">
      {/* Main Content */}
      <div className="space-y-12 md:space-y-[1.25vw]">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 gap-8 lg:gap-[2vw] max-w-xl md:max-w-2xl lg:max-w-[42vw] mx-auto">
        ...
        {/* Benefits Grid */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 lg:gap-[1.25vw]   ">
          ...
          <div className="hover:bg-[#D5C1F6] border border-[#A3A3A3] duration-300 rounded-lg md:rounded-[0.833vw] p-6 md:p-[1.25vw] relative">
            ...
            <h3 className="text-[16px] md:text-24 lg:leading-[2.5vw] font-semibold mt-2 md:mt-[0.208vw]">
          ...
          <PiCellTower className="text-white text-3xl md:text-36 bg-[#553094] rounded-full p-1.5 md:p-[0.308vw]" />
            ...
            <h3 className="text-[16px] md:text-24 font-semibold mt-2 lg:leading-[2.5vw] md:mt-[0.208vw]">
          ...
          <FaShoppingBag className="text-white text-3xl md:text-36 bg-[#553094] rounded-full p-1.5 md:p-[0.308vw]" />
            ...
            <h3 className="text-[16px] md:text-24 font-semibold lg:leading-[2.5vw] mt-2 md:mt-[0.208vw]">
