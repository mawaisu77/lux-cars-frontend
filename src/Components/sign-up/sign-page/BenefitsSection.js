      ...
      <div className="space-y-12 md:space-y-[1.25vw]">
        ...
        <div className="grid grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600 mt-2 md:mt-[0.208vw]">Community</div>
          </div>
        </div>

        {/* Benefits Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-[1.25vw]">
          ...
          <div className="hover:bg-[#D5C1F6] border border-[#A3A3A3] duration-300 rounded-lg md:rounded-[0.833vw] p-6 md:p-[1.25vw] relative">
            ...
            <h3 className="text-lg md:text-24 font-semibold mt-2 md:mt-[0.208vw]">
