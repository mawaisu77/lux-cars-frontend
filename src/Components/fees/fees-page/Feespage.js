...
// feesRightCard
import { feesRightCard } from "../../../data/data.js";
function Feespage() {
  return (
    <>
      ...
      <div className="w-auto px-[16px] md:px-[0px] w-[100%] md:w-[80vw]  lg:w-[73.177vw]  mx-auto md:mt-[4.167vh] :md:mb-[4.167vh] mt-[70px] mb-[70px]">
        <div className="md:flex md:justify-between ">
          <div className="w-auto w-[100%] md:w-[44vw] lg:w-[38.073vw] ">
            <div className="">
              ...
              <div className="relative">
                ...
                <img
                  src={image3}
                  className=" w-[200px] md:w-[14vw] absolute top-[56px] md:top-[10.917vh] left-[25px] md:left-[1.5vw]"
                />
              </div>
            </div>
            <div className="md:mt-[1.25vh]  mt-[40px]">
              <h2 className="text-left text-[24px] md:text-[1.25vw] font-[700] text-[#1F1F2C] font-urbanist">
                Advantages Of Bidding Through Lux First Choice Cars
              </h2>

              <div className="  flex flex-wrap justify-center md:justify-start gap-[12px]">
          ...
          <div className="w-[100%] md:w-[33.542vw] md:mt-[0vw] mt-[140px] ">
            ...
            <h2 className="text-left text-[20px] md:text-[1.35vw] font-[700] text-[#1F1F2C] font-urbanist mb-[1.25vh]">
        ...
        <div className="md:mt-[3vh] mt-[100px] md:mb-[3vh] mb-[100px]">
          <h2 className="text-left text-[36px] md:text-[1.25vw] font-[700] text-[#1F1F2C] font-urbanist">
            Fees:
          </h2>
          ...
          <div className="text-left flex gap-[10px] md:gap-[0.521vw] mt-[1.563vh] mb-[0.833vh]">
            <button className="py-[10px] w-[100px] md:w-[5.208vw] h-[100px] md:h-[5vh] md:py-[0.521vh] px-[17px] md:px-[0.885vw] rounded-[6px] md:rounded-[0.313vw] bg-[#CA0000] text-[15px]  md:text-[0.781vw] font-[500] text-[#FFFFFF] font-urbanist">
              COPART
            </button>
            <button className="py-[10px] md:py-[0.521vh] w-[60px] md:w-[3.125vw] h-[100px] md:h-[5vh]  px-[17px] md:px-[0.885vw] rounded-[6px] md:rounded-[0.313vw] bg-[#F8F8F8] text-[15px] md:text-[0.781vw] font-[500] text-[#1F1F2C] font-urbanist">
              IAAI
            </button>
          </div>
        </div>
        <div className=" w-[66.823vw] mx-auto mb-[50px] md:mb-[1.719vh]">
          <div className="flex flex-wrap justify-between">
            ...
            <div className="flex flex-wrap justify-center items-center  gap-[0.417vw]">
              <select className="md:w-[6.5vw] lg:w-[6.25vw] rounded-[4px] md:rounded-[0.417vw] border border-[#131313] outline-none h-[2.781vh] text-left text-[10px] md:text-[0.5vw] lg:text-[0.529vw] font-[400] font-urbanist">
        ...
        <div className=" w-[66.823vw] mx-auto  mb-[20px] md:mb-[1.719vh]">
          <div className="flex flex-wrap justify-between">
            <div className="text-left flex items-center flex-wrap gap-[0.417vw]">
              ...
              <h2 className="text-left text-[18px] md:text-[0.938vw] font-[600] text-[#7A798A] font-urbanist">
                Virtual Bid Fee
              </h2>
            </div>
            <div className="hidden md:flex flex-wrap justify-center items-center  gap-[0.417vw]">
              <select className="md:w-[6.5vw] lg:w-[6.25vw] border-grey-400 outline-none rounded-[0.417vw] border border-[#131313] outline-none h-[2.781vh] text-left md:text-[0.5vw] lg:text-[0.529vw] font-[400] font-urbanist">
                <option >General fee</option>
                <option>General fee</option>
                <option>General fee</option>
              </select>
          ...
          <button className="text-left text-[15px] md:text-[0.781vw] w-[130px] md:w-[6.771vw] h-[50px] md:h-[5.208vh] rounded-[30px] md:rounded-[1.563vw] bg-[#F3F3F6] py-[0.833vh] px-[2.083vh] font-[700] text-[#CA0000] font-urbanist text-center">
            Load More
          </button>
        </div>
        <div className="mt-[30px] md:mt-[1.563vh]">
          <h2 className="text-left text-[24px] md:text-[1.25vw]  font-[700] text-[#1F1F2C] font-urbanist mb-[30px] md:mb-[0vh]">
            Gate fee
          </h2>
