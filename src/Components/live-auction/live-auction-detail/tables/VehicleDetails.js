export default function VehicleDetails({vehicle}) {
    ...
    return (
      <div className="w-full mx-auto ">
        <h1 className="text-2xl md:text-30 bg-pink-400 p-2 rounded-md md:rounded-[0.5vw] font-bold text-center md:mb-[0.2vw]">Vehicle Details</h1>
          {/* Grid Section */}
        <div className="grid w-full grid-cols-12 gap-[10px] lg:gap-[0.2vw]">
            ...
            <div className="bg-white col-span-12 rounded-md md:rounded-[0.5vw] shadow-sm p-2 lg::p-[1.25vw]">
              <div className="space-y-[10px] lg:space-y-[0.925vw]">
