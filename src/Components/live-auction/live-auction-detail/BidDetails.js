      ...
      <div className="p-3 max-w-[100%] mx-auto">
        <div className="flex justify-between items-center mb-3">
          ...
          <div className="flex items-center gap-2 ">
            ...
            <span className="text-[16px] font-medium bg-green-700/30 px-2 py-0.5 rounded-lg">
          ...
          <div className="flex gap-4">
            <div className="flex  items-center  px-2 py-1 gap-1 bg-secondary-gray rounded-3xl">
              <People className="text-[14px]" />{" "}
              <span className="text-[14px]">{memberCount || 0}</span>
            </div>
          </div>
        </div>
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <div className="relative mb-4 grid grid-cols-12 p-3 rounded-md shadow-md">
              <div className="col-span-8">
                <div className="mb-2 grid grid-cols-12  items-center">
                  <div className="flex flex-col col-span-8 items-center relative mb-2">
                    <span className="text-[15px] mb-[12px] font-medium">
                      Active Bid:
                    </span>
              ...
              <div className="col-span-4">
                <h1 className="text-[15px] mb-[12px] font-medium">
                  Quick Bid Increase
                </h1>
            ...
            <div className="w-full mt-3 text-left">
              <span className=" text-[16px] font-medium">Auto Bid For Me</span>
